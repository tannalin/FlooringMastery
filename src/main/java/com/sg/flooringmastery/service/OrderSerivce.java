...
public interface OrderSerivce {
    ...
    Order addOrder(Integer orderNumber, Order order)
            throws OrderDataValidationException, OrderDataDuplicationException;
    ...
    Integer getPreviousOrderNumber() throws OrderDataValidationException,OrderDataDuplicationException;

    void writeOrderNumberToFile(Integer orderNumber) throws OrderDataValidationException,OrderDataDuplicationException;
    List<Order> getOrdersBaseOnDate(String date) throws OrderDataValidationException, OrderDataDuplicationException;

    void editOrder(Integer orderNumber, Order order) throws OrderDataDuplicationException, OrderDataValidationException;

    void exportOrders() throws OrderDataDuplicationException, OrderDataValidationException;
}
